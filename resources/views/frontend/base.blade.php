...
<head>
    ...
    <!-- IziToast -->
    <link rel="stylesheet" href="/templates/assetsAdmin/vendor/izitoast/css/iziToast.min.css">
    <!-- =======================================================
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="getstarted scrollto" href="/userLogout">Выйти</a></li>
            </ul>
...
<!-- IziToast -->
<script src="/templates/assetsAdmin/vendor/izitoast/js/iziToast.min.js" type="text/javascript"></script>
